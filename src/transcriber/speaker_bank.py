...
class SpeakerBankConfig:
    ...
    repair_merge_same_raw_gap_seconds: float = 0.20
    repair_snap_boundary_seconds: float = 0.20
    repair_max_overlap_trim_seconds: float = 0.30
    repair_split_on_word_gap_seconds: float = 0.35
    repair_max_seed_overlap_seconds: float = 0.15
    repair_min_segment_duration_seconds: float = 0.35
    session_graph_enabled: bool = False
    session_graph_candidate_top_k: int = 3
    session_graph_candidate_floor: float = 0.20
    session_graph_knn: int = 8
    session_graph_min_similarity: float = 0.25
    session_graph_anchor_weight: float = 1.0
    session_graph_temporal_weight: float = 0.35
    session_graph_temporal_tau_seconds: float = 0.75
    session_graph_temporal_max_gap_seconds: float = 2.0
    session_graph_same_raw_label_weight: float = 0.25
    session_graph_same_top1_weight: float = 0.10
    session_graph_alpha: float = 0.85
    session_graph_max_iters: int = 30
    session_graph_tolerance: float = 1e-4
    session_graph_strong_seed_score: float = 0.60
    session_graph_strong_seed_margin: float = 0.12
    session_graph_override_min_confidence: float = 0.55
    session_graph_override_min_margin: float = 0.12
    session_graph_override_min_delta: float = 0.03
    session_graph_pair_overrides: Dict[str, Dict[str, float]] = field(default_factory=dict)
    emit_pca: bool = True
